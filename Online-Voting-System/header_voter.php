...
<head>
    ...
    <title>Voter Dashboard - Online Voting System by Himanshu Kumar</title>
    ...
    " role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a href="index.php" class="navbar-brand headerFont text-lg" style="color: #FF6B6B; font-weight: bold;">🗳️ Online Voting System</a>
                </div>
