        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="simple_register.php"><strong>📝 Register</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="simple_login.php"><strong>🔐 Login</strong></a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
        ...
        <div class="main-header">
            <div class="container">
                ...
                <div style="margin-top: 30px;">
                    <a href="simple_register.php" class="btn-custom">📝 Register to Vote</a>
                    <a href="simple_login.php" class="btn-custom">🔐 Login</a>
                    <a href="simple_results.php" class="btn-custom">📊 View Results</a>
                    <a href="multi_question_voter.php" class="btn-custom">🗳️ Multi-Question Vote</a>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin: 50px 0;">
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <a href="simple_register.php" class="btn btn-light btn-sm">Get Started</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
                    ...
                    <a href="simple_login.php" class="btn btn-light btn-sm">Login First</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); color: #333;">
                    ...
                    <a href="simple_results.php" class="btn btn-dark btn-sm">View Results</a>
                </div>
            </div>
        </div>
